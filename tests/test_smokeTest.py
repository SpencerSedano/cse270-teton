...
class TestSmokeTest():
  ...
  def test_adminPageTest(self):
    ...
    self.driver.set_window_size(743, 928)
  ...
  def test_homePageTest1(self):
    ...
    self.driver.set_window_size(688, 756)
  ...
  def test_homePageTest2(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1292, 756)
  ...
  def test_joinPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Spencer")
    self.driver.find_element(By.NAME, "lname").send_keys("Sedano")
    self.driver.find_element(By.NAME, "bizname").send_keys("Hoverzi")
